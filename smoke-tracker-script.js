...
document.addEventListener('DOMContentLoaded', () => {
    ...
    function triggerCigarettePuff() {
        ...
        for (let i = 0; i < numParticles; i++) {
            ...
            const radiusX = rect.width / 2; const radiusY = rect.height / 2;
    ...
    function applyThemeOnPage(themeId) {
        ...
        // saveState(); // Theme changes are saved on shop page or when this is called from there.
                      // On this page, it primarily applies the loaded theme.
    }
    ...
    // =================================================================================
    loadState();
    initializeParticleCanvas(); // Initialize particle canvas
    ...
    console.log("Smoke Tracker Initialized (v7.1 - Full Commented Particle Version).");
